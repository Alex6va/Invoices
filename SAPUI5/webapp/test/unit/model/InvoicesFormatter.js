...
sap.ui.define([
    ...
    function (InvoicesFormatter, ResourceModel) {
        ...
        QUnit.test("Should return the Invoice Status", function(assert){
            ...
            //Assert 
            assert.strictEqual(fnIsolatedFormatter("A"), "New", "The invoice of the status A is correct");
            assert.strictEqual(fnIsolatedFormatter("B"), "In progress", "The invoice of the status B is correct");
            assert.strictEqual(fnIsolatedFormatter("C"), "Done", "The invoice of the status C is correct");
        });
    });