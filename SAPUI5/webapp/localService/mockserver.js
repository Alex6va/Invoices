...
sap.ui.define([
    ...
    function (MockServer, JSONModel, UriParameters, Log ) {
        ...
        var oMockServerInterface = {
            ...
            /**
             * Initialized the mock server asynchronously
             * @protected
            ...
            init: function(oOptionsParameter) {
                ...
                return new Promise (function(fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function() {
                        ...
                        var oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/northwind.svc");
                        var sMetadataUrl = sap.ui.require.toUrl(_sAppPath + oMainDataSource.settings.localUri);
                        //ensure there is a trailing slash
                        var sMockServerUrl = oMainDataSource.uri &&
                                   new URI(oMainDataSource.uri).absoluteTo(sap.ui.require.toUrl(_sAppPath)).toString();

                        //create a mock server instance or stop the existing one to reinitilize
